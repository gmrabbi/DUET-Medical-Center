...
<html>
  <head>
    <title>DUET Medical center | Registration</title>
    ...
    <script>
      function validform() {
        var y = document.forms["regform"]["firstname"].value;
        if (y == "") {
          alert("First-Name Empty");
          document.forms["regform"]["firstname"].focus();
          return false;
        }
        y = document.forms["regform"]["lastname"].value;
        if (y == "") {
          alert("Last-Name Empty");
          document.forms["regform"]["lastname"].focus();
          return false;
        }
        y = document.forms["regform"]["email"].value;
        if (y == "") {
          alert("Email Empty");
        ...
        var passwordStrengthPattern = /^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[!@#$%^&*(),.?":{}|<>]).{8,}$/;
        if (!passwordStrengthPattern.test(pass1)) {
        ...
        if (pass2 == "") {
          ...
          document.forms["regform"]["cpassword"].focus();
          return false;
        }
            ...
            >
              <div class="reg-header">
                ...
                <p>
                  ...
                  <a href="login.php" class="color-green">Sign In</a> to login
                  your account.
                </p>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <label
                    >Confirm Password <span class="color-red">*</span></label
                  >
                  <input
                    type="password"
                    name="cpassword"
              ...
              <div class="row">
                ...
                <div class="col-lg-6 text-right">
                  <button class="btn-u" type="submit" name="reg">
                    Register
                  </button>
                </div>
              </div>
