...
<head>
	<title>DUET medical center | Contact Us</title>
...
<body>
  ...
  <!-- Other content of your page -->
		...
		<div class="container">
			<!-- Picture and name -->
			<div class="picture">
				<img src="assets/img/team/Dr. Ali Asger Khan.jpg" alt="" />
			</div>
			...
			<div class="info-box">
				<div class="details">
					<ul>
						<li class="about">
							Dr. Ali Asger Khan, Head of the Office, is a highly dedicated and responsible doctor. He
							consistently prioritizes patient care with a compassionate and empathetic approach. As a
							leader, he ensures efficient office operations and upholds high standards of care. His
							commitment to both his patients and team reflects his professionalism and responsibility in
			...
			<div class="social-media">
				<a href="mailto:alikhan72@duet.ac.bd">
					<div>Email</div>
				</a>
